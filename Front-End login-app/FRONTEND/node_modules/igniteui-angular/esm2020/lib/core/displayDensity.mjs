...
DisplayDensityBase.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: DisplayDensityBase, deps: [{ token: DisplayDensityToken, optional: true }], target: i0.ɵɵFactoryTarget.Directive });
DisplayDensityBase.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "14.0.0", type: DisplayDensityBase, selector: "[igxDisplayDensityBase]", inputs: { displayDensity: "displayDensity" }, outputs: { onDensityChanged: "onDensityChanged" }, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: DisplayDensityBase, decorators: [{
            type: Directive,
            args: [{
...
IgxDisplayDensityModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: IgxDisplayDensityModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
IgxDisplayDensityModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.0", ngImport: i0, type: IgxDisplayDensityModule, declarations: [DisplayDensityBase], exports: [DisplayDensityBase] });
IgxDisplayDensityModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: IgxDisplayDensityModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: IgxDisplayDensityModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
                        DisplayDensityBase

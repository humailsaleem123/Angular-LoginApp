...
IgxSelectItemComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: IgxSelectItemComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
IgxSelectItemComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.0", type: IgxSelectItemComponent, selector: "igx-select-item", inputs: { text: "text" }, usesInheritance: true, ngImport: i0, template: '<span class="igx-drop-down__inner"><ng-content></ng-content></span>', isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: IgxSelectItemComponent, decorators: [{
            type: Component,
            args: [{

...
DisplayContainerComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: DisplayContainerComponent, deps: [{ token: i0.ChangeDetectorRef }, { token: i0.ViewContainerRef }], target: i0.ɵɵFactoryTarget.Component });
DisplayContainerComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.0", type: DisplayContainerComponent, selector: "igx-display-container", host: { properties: { "class": "this.cssClass", "class.igx-display-container--inactive": "this.notVirtual" } }, viewQueries: [{ propertyName: "_vcr", first: true, predicate: ["display_container"], descendants: true, read: ViewContainerRef, static: true }, { propertyName: "_scrollInertia", first: true, predicate: ["display_container"], descendants: true, read: IgxScrollInertiaDirective, static: true }], ngImport: i0, template: `
        <ng-template
            #display_container
            igxScrollInertia
    ...
    `, isInline: true, dependencies: [{ kind: "directive", type: i1.IgxScrollInertiaDirective, selector: "[igxScrollInertia]", inputs: ["IgxScrollInertiaDirection", "IgxScrollInertiaScrollContainer", "wheelStep", "inertiaStep", "smoothingStep", "smoothingDuration", "swipeToleranceX", "inertiaDeltaY", "inertiaDeltaX", "inertiaDuration"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.0", ngImport: i0, type: DisplayContainerComponent, decorators: [{
            type: Component,
            args: [{

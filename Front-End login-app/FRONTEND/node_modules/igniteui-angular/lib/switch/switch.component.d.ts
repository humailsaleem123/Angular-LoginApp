...
export declare class IgxSwitchRequiredDirective extends CheckboxRequiredValidator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<IgxSwitchRequiredDirective, "igx-switch[required][formControlName],    igx-switch[required][formControl],    igx-switch[required][ngModel]", never, {}, {}, never, never, false>;
}
/**
 * @hidden
 */

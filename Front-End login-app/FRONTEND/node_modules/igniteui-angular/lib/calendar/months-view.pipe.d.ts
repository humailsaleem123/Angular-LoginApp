...
export declare class IgxMonthViewSlotsCalendar implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxMonthViewSlotsCalendar, "IgxMonthViewSlots", false>;
}
export declare class IgxGetViewDateCalendar implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxGetViewDateCalendar, "IgxGetViewDate", false>;
}

...
export declare class IgxChildGridRowComponent implements AfterViewInit, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxChildGridRowComponent, "igx-child-grid-row", never, { "layout": "layout"; "parentGridID": "parentGridID"; "data": "data"; "index": "index"; }, {}, never, never, false>;
}
export declare class IgxHierarchicalGridComponent extends IgxHierarchicalGridBaseDirective implements GridType, AfterViewInit, AfterContentInit, OnInit, OnDestroy, DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxHierarchicalGridComponent, "igx-hierarchical-grid", never, { "id": "id"; "data": "data"; "expandChildren": "expandChildren"; }, {}, ["toolbarTemplate", "childLayoutList", "allLayoutList", "paginatorList"], ["igx-grid-toolbar", "igx-grid-footer", "igx-paginator"], false>;
}

...
export declare class IgxGridHierarchicalPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxGridHierarchicalPipe, "gridHierarchical", false>;
}
/**
 * @hidden
 */
export declare class IgxGridHierarchicalPagingPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxGridHierarchicalPagingPipe, "gridHierarchicalPaging", false>;
}

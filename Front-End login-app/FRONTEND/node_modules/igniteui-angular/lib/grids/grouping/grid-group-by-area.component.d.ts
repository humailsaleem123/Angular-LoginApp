...
export declare class IgxGridGroupByAreaComponent extends IgxGroupByAreaDirective {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxGridGroupByAreaComponent, "igx-grid-group-by-area", never, { "sortingExpressions": "sortingExpressions"; "grid": "grid"; }, {}, never, never, false>;
}

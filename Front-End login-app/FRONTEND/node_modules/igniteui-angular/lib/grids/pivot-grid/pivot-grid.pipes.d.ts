...
export declare class IgxPivotRowPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotRowPipe, "pivotGridRow", false>;
}
/**
 * @hidden
...
export declare class IgxPivotAutoTransform implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotAutoTransform, "pivotGridAutoTransform", false>;
}
/**
 * @hidden
 */
export declare class IgxPivotRowExpansionPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotRowExpansionPipe, "pivotGridRowExpansion", false>;
}
/**
 * @hidden
 */
export declare class IgxPivotCellMergingPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotCellMergingPipe, "pivotGridCellMerging", false>;
}
/**
 * @hidden
 */
export declare class IgxPivotColumnPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotColumnPipe, "pivotGridColumn", false>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridFilterPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridFilterPipe, "pivotGridFilter", false>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridColumnSortingPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridColumnSortingPipe, "pivotGridColumnSort", false>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridSortingPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridSortingPipe, "pivotGridSort", false>;
}
/**
 * @hidden
 */
export declare class IgxFilterPivotItemsPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxFilterPivotItemsPipe, "filterPivotItems", false>;
}
...
export declare class IgxPivotGridCellStyleClassesPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridCellStyleClassesPipe, "igxPivotCellStyleClasses", false>;
}
export {};

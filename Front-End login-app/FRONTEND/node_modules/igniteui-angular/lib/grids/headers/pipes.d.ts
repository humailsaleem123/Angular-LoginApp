...
export declare class SortingIndexPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<SortingIndexPipe, "sortingIndex", false>;
}
export declare class IgxHeaderGroupWidthPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxHeaderGroupWidthPipe, "igxHeaderGroupWidth", false>;
}
export declare class IgxHeaderGroupStylePipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxHeaderGroupStylePipe, "igxHeaderGroupStyle", false>;
}

...
export declare class IgxInputGroupComponent extends DisplayDensityBase implements IgxInputGroupBase, AfterViewChecked, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxInputGroupComponent, "igx-input-group", never, { "resourceStrings": "resourceStrings"; "suppressInputAutofocus": "suppressInputAutofocus"; "type": "type"; "theme": "theme"; }, {}, ["input", "hints"], ["igx-hint, [igxHint]", "[igxLabel]", "[igxInput]", "igx-prefix, [igxPrefix]", "igx-suffix, [igxSuffix]"], false>;
}
/** @hidden */
